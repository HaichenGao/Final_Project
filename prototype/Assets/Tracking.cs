...
public class Tracking : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        point.transform.localPosition = new Vector3(amplitude*(Mathf.Sin(2.07f*Time.time) + Mathf.Sin(1.65f*Time.time) + Mathf.Sin(0.23f*Time.time) + Mathf.Sin(0.37f*Time.time)), amplitude*(Mathf.Sin(2.07f*Time.time + 0.5f*Mathf.PI) + Mathf.Sin(0.96f*Time.time + 0.5f*Mathf.PI) + Mathf.Sin(1.98f*Time.time) + Mathf.Sin(1.08f*Time.time)), 0f);
